              ...
              <ul class="navbar-nav header-right">
                    @if (session()->has('get_kundli'))
                        <li class="nav-item dropdown notification_dropdown">
                            <a class="nav-link bell bell-link" href="{{ url('/') }}?new=1">
                                <i id="icon-light" class="fas fa-add"></i> Another kundli
                            </a>
                        </li>
                    @endif
                  ...
                  @if (auth()->check())
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                            ...
                            <img src="front/images/profile/pic1.jpg" width="20" alt="" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item ai-icon" href="javascript:void(0)">
