        ...
        <ul class="metismenu" id="menu">
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                    ...
                    <span class="nav-text">Dosha</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="index-2.html">Mangal Dosh</a></li>
                    <li><a href="index-3.html">Kaalsarp Dosh</a></li>
                    <li><a href="my-wallet.html">Manglik Dosh</a></li>
                    <li><a href="coin-details.html">Pitra Dosh</a></li>
                    <li><a href="portfolio.html">Papasamaya</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                    <i class="flaticon-app-store"></i>
                    <span class="nav-text">Dashas</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="app-profile.html">Mahadasha</a></li>
                    <li><a href="app-profile.html">antardasha</a></li>
                    <li><a href="app-profile.html">charDashaCurrent</a></li>
                    <li><a href="app-profile.html">CharDashaMain</a></li>
                    <li><a href="app-profile.html">CharDashaSub</a></li>
                    <li><a href="app-profile.html">currentMahaDashaFull</a></li>
                    <li><a href="app-profile.html">CurrentMahadasha</a></li>
                    <li><a href="app-profile.html">ParyantarDasha</a></li>
                    <li><a href="app-profile.html">SpecificDasha</a></li>
                    <li><a href="app-profile.html">yoginiDashaMain</a></li>
                    <li><a href="app-profile.html">YoginiDashaSub</a></li>
                </ul>
            </li>
            <li>
                <a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
